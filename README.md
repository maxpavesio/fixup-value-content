...
> ## 🌐 [→ APRI IL SITO LIVE](https://maxpavesio.github.io/fixup-value-content/)
>
> **Questo è il repository sorgente.** Per vedere le pagine renderizzate (demo interattive, report, organigramma) clicca il link sopra.
...
| Demo | Live URL |
|------|----------|
| 🏠 **Index Value Content** | https://maxpavesio.github.io/fixup-value-content/ |
...
- `index.html` — landing showcase con tutte le card cliccabili
...
- Asset linkati nei follow-up email FIXUP a prospect
- Versione mirror anche su Notion teamspace `value-content`
- **Nota**: l'URL `github.com/maxpavesio/fixup-value-content` mostra il codice sorgente, **non** il sito navigabile. Per le demo aprire sempre `maxpavesio.github.io/fixup-value-content/`.

---

© 2026 FIXUP Agency · [info@fixup.agency](mailto:info@fixup.agency) · [fixup.agency](https://fixup.agency)
